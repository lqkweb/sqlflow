...
_lr_productions = [
    ...
    (
        ...
        'non_mattrtype_list',
        3, 'p_non_mattrtype_list', 'parser.py', 203),
    ('non_mattrtype_list -> attrtype', 'non_mattrtype_list', 1,
     'p_non_mattrtype_list', 'parser.py', 204),
    ...
    ('non_mselect_clause -> non_mrelattr_list', 'non_mselect_clause', 1,
     'p_non_mselect_clause', 'parser.py', 230),
    ...
    ('non_mrelattr_list -> relattr', 'non_mrelattr_list', 1,
     'p_non_mrelattr_list', 'parser.py', 237),
    ...
    ('non_mcond_list -> ( non_mcond_list )', 'non_mcond_list', 3,
     'p_non_mcond_list', 'parser.py', 291),
